...
class Helper(Node):
    def __init__(self):
        ...
        # subscribers
        self.sub_robot_position = self.create_subscription(Odometry, "/odometry/filtered", self.robot_callback, 1)
        self.sub_ped_one_position = self.create_subscription(Odometry, "/crowd/ped_1", self.ped_one_callback, 1)
        self.sub_ped_two_position = self.create_subscription(Odometry, "/crowd/ped_2", self.ped_two_callback, 1)
        self.sub_ped_three_position = self.create_subscription(Odometry, "/crowd/ped_3", self.ped_three_callback, 1)
        self.sub_ped_four_position = self.create_subscription(Odometry, "/crowd/ped_4", self.ped_four_callback, 1)
        self.sub_ped_five_position = self.create_subscription(Odometry, "/crowd/ped_5", self.ped_five_callback, 1)
    ...
    def ped_one_callback(self, msg):
        if self.peds_time[0] == 0.0:
            ...
            self.robot_position[0,1] = msg.pose.pose.position.y
    ...
    def ped_two_callback(self, msg):
        if self.peds_time[1] == 0.0:
            ...
            self.robot_position[1,1] = msg.pose.pose.position.y
    ...
    def ped_three_callback(self, msg):
        if self.peds_time[2] == 0.0:
            ...
            self.robot_position[2,1] = msg.pose.pose.position.y
    ...
    def ped_four_callback(self, msg):
        if self.peds_time[3] == 0.0:
            ...
            self.robot_position[3,1] = msg.pose.pose.position.y
    ...
    def ped_five_callback(self, msg):
        if self.peds_time[4] == 0.0:
            ...
            self.robot_position[4,1] = msg.pose.pose.position.y
    ...
    def robot_info_callback(self):
        ...
        robot_velocity_msg.x = self.robot_velocity[0,0]
        robot_velocity_msg.y = self.robot_velocity[0,1]
    ...
    def peds_info_callback(self):
        ...
        for ped in range(self.num):
            msg.ids[ped] = self.peds_ids[ped]
            msg.position[ped].x = self.peds_position[ped, 0]
            msg.position[ped].y = self.peds_position[ped, 1]
            msg.velocity[ped].x = self.peds_velocity[ped, 0]
            msg.velocity[ped].y = self.peds_velocity[ped, 1]
            msg.radius[ped] = self.peds_radius
