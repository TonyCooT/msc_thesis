...
void ModelMove::InitiateMove()
{
  ...
  key->Translation(ignition::math::Vector3d(this->startPosition.X(), this->startPosition.Y(), this->startPosition.Z()));
  key->Rotation(ignition::math::Quaterniond(0, 0, 0));

  ignition::math::Vector3d translation = ignition::math::Vector3d(this->startPosition.X(), this->startPosition.Y(), this->startPosition.Z());
